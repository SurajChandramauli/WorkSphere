...
import { getAllProjectsAppliedByOwn } from "../../redux/actions/index.js";
...
const OwnAppliedProjects = (props) => {
  ...
  useEffect(() => {
    props.getAllProjectsAppliedByOwn(loggedInUserId);
  }, [props.allProjectsByAppledByOwn]);
  ...
  return (
    <Template>
      ...
      <Grid
        container
        spacing={3}
        sx={{ paddingLeft: "150px", marginTop: "-40px" }}
      >
        {props.allProjectsByAppledByOwn &&
        props.allProjectsByAppledByOwn.length > 0
          ? props.allProjectsByAppledByOwn.map((project) => (
...
const mapStateToProps = (state) => {
  return {
    allProjectsByAppledByOwn:
      state.testMockApiDataSetup.allProjectsByAppledByOwn,
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(OwnAppliedProjects);
